...
- (void)viewDidLoad {
    ...
    inBubbleImage=[bubbleFactory incomingMessagesBubbleImageWithColor:[UIColor jsq_messageBubbleBlueColor]];
     ...
     NSData *photoData = [[[XMPPChatManager shareInstance] vatarModule] photoDataForJID:self.currentUser.jid];
    if (photoData != nil){
    ...
    photoData = [[[XMPPChatManager shareInstance] vatarModule] photoDataForJID:jid];
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    {
        NSManagedObjectContext *moc = [[XMPPChatManager shareInstance] messageContext];
...
//    [self receiveAutoMessage];
    ...
    [[XMPPChatManager shareInstance]sendMessage:text toUser:self.currentUser.jid];
